        ...
        <div id="front-1-banner" class="vd_banner vd_bg-white clearfix slide-waypoint" data-waypoint="home" >
            <div id="layerslider" style="width:100%;height:500px;">
                <div class="ls-slide" data-ls="slidedelay:7500;transition2d:8;">
                    ...
                    <a href="index-2.html" class="ls-l"  style="top:220px;left:1000px;" data-ls="durationin:1500;delayin:5000;rotatein:20;rotatexin:30;scalexin:1.5;scaleyin:1.5;transformoriginin:left 50% 0;durationout:750;rotateout:20;rotatexout:-30;scalexout:0;scaleyout:0;transformoriginout:left 50% 0;">
                        ...
                        <div class="col-md-offset-3 col-sm-offset-2 col-md-6 col-sm-8">
                            <div class="panel">
                                <div class="panel-body vd_bg-green radius-10" >
                                    ...
                                    <form role="form" action="http://www.venmond.com/demo/vendroid/functions/contact.php" id="contact-form-widget" class="form-horizontal">
