                        ...
                        <div class="vd_content-section clearfix">
                            <div class="vd_login-page">
                                <div class="heading clearfix">
                                    ...
                                    <h4 class="text-center font-semibold vd_grey">LOTOHANEM YÖNETİCİ Şifre Hatırla</h4>
                                </div>
                                <div class="panel widget">
                                    <div class="panel-body">
                                        <div class="login-icon entypo-icon"> <i class="icon-key"></i> </div>
                                        <form class="form-horizontal" id="login-form" method="POST" action="{{ route('yonetici.password.email') }}" role="form">
                                            @csrf
                                            <div class="form-group  mgbt-xs-20">
                                                ...
                                                <div class="col-md-12 text-center mgbt-xs-5">
                                                    <button class="btn vd_bg-green vd_white width-100" type="submit" id="login-submit">Şifremi Gönder</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
